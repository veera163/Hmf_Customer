package hmf.com.project.hmfcustomer;
...
import hmf.com.project.hmfcustomer.domains.UserDomain;
import hmf.com.project.hmfcustomer.logger.L;
...
public class ESurvey extends Application {
   ...
   // public static final String URL = "http://192.168.0.105:9090";
    ...
    public static void saveType(String consumerType) {
        editor.putString(TYPE,consumerType);
        editor.commit();
